...
ax = axes[0]
ax.semilogx(X1['N'], X1['To']/X1['Tb'], color=colors[0], linewidth='1',
            label='2.2 GHz')
ax.semilogx(X2['N'], X2['To']/X2['Tb'], color=colors[1], linewidth='1',
            label='4.6 GHz')
...
ax = axes[1]
ax.loglog(X1['N'], X1['To'], color=colors[0], linewidth='1',
          linestyle='solid', label=r'\texttt{olim6\_rhr} (2.2 GHz)')
ax.loglog(X1['N'], X1['Tb'], color=colors[0], linewidth='1',
          linestyle='dashed', label=r'\texttt{FMM} (2.2 GHz)')
ax.loglog(X2['N'], X2['To'], color=colors[1], linewidth='1',
          linestyle='solid', label=r'\texttt{olim6\_rhr} (4.6 GHz)')
ax.loglog(X2['N'], X2['Tb'], color=colors[1], linewidth='1',
