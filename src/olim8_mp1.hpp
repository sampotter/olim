...
using olim8_mp1 = olim8<update_rules::mp_line_updates, olim8_mp1_update_rules>;
using olim8hu_mp1 = olim8hu<update_rules::mp_line_updates, olim8_mp1_update_rules>;
using olim8lut_mp1 = olim8lut<update_rules::mp_line_updates, olim8_mp1_update_rules>;
