...
TEST (cost_funcs, F0_bv_works) {
  double u[3], h, s_hat, s[3], lam[2], theta, f, df[2], d2f[2][2];
  {
    ...
    ASSERT_NEAR(d2f[0][0], 0.943029793001913, 1e-14);
    ASSERT_NEAR(d2f[0][1], 0.527894715268843, 1e-14);
    ASSERT_NEAR(d2f[1][0], 0.527894715268843, 1e-14);
    ASSERT_NEAR(d2f[1][1], 0.7737643062783994, 1e-14);
  }
  {
    ...
    ASSERT_NEAR(d2f[0][0], 0.5985660352927444, 1e-14);
    ASSERT_NEAR(d2f[0][1], 0.5388901749337961, 1e-14);
    ASSERT_NEAR(d2f[1][0], 0.5388901749337961, 1e-14);
    ASSERT_NEAR(d2f[1][1], 1.130148012648721, 1e-14);
  }
  {
    ...
    ASSERT_NEAR(d2f[0][0], 0.5474635694041445, 1e-14);
    ASSERT_NEAR(d2f[0][1], 0.3126629815900731, 1e-14);
    ASSERT_NEAR(d2f[1][0], 0.3126629815900731, 1e-14);
    ASSERT_NEAR(d2f[1][1], 0.6770061619648891, 1e-14);
  }
}
...
TEST (cost_funcs, F1_bv_works) {
  double u[3], h, s_hat, s[3], lam[2], theta, f, df[2], d2f[2][2];
  {
    ...
    ASSERT_NEAR(d2f[0][0], 0.2056917201680957, 1e-14);
    ASSERT_NEAR(d2f[0][1], -0.06332599691710795, 1e-14);
    ASSERT_NEAR(d2f[1][0], -0.06332599691710795, 1e-14);
    ASSERT_NEAR(d2f[1][1], -0.03275544921492105, 1e-14);
  }
  {
    ...
    ASSERT_NEAR(d2f[0][0], 0.445481028600332, 1e-14);
    ASSERT_NEAR(d2f[0][1], 0.3529892838408903, 1e-14);
    ASSERT_NEAR(d2f[1][0], 0.3529892838408903, 1e-14);
    ASSERT_NEAR(d2f[1][1], 0.4951344002306139, 1e-14);
  }
  {
    ...
    ASSERT_NEAR(d2f[0][0], 0.4011319192097169, 1e-14);
    ASSERT_NEAR(d2f[0][1], 0.1841371483412766, 1e-14);
    ASSERT_NEAR(d2f[1][0], 0.1841371483412766, 1e-14);
    ASSERT_NEAR(d2f[1][1], 0.4140286901087806, 1e-14);
  }
}
