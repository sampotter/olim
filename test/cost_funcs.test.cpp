...
TEST (cost_funcs, F0_works) {
  ...
  double lam[2] = {1./3, 1./3};
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.3629059042422889);
    ASSERT_DOUBLE_EQ(df[0], 0.09385069562055104);
    ASSERT_DOUBLE_EQ(df[1], -0.005830975252270845);
    ASSERT_DOUBLE_EQ(d2f[0][0], 0.01398478137316401);
    ASSERT_DOUBLE_EQ(d2f[0][1], -0.03387057681332327);
    ASSERT_DOUBLE_EQ(d2f[1][0], -0.03387057681332326);
    ASSERT_DOUBLE_EQ(d2f[1][1], 0.2802160611291685);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.8529368893174771);
    ASSERT_DOUBLE_EQ(df[0], -0.1025834491128786);
    ASSERT_DOUBLE_EQ(df[1], -0.3596024800247133);
    ASSERT_DOUBLE_EQ(d2f[0][0], 1.272103018002429);
    ASSERT_DOUBLE_EQ(d2f[0][1], 0.135763147743216);
    ASSERT_DOUBLE_EQ(d2f[1][0], 0.135763147743216);
    ASSERT_DOUBLE_EQ(d2f[1][1], 0.2751072086015301);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.9386573623510739);
    ASSERT_DOUBLE_EQ(df[0], 0.2848236230267062);
    ASSERT_DOUBLE_EQ(df[1], -0.1374461352207875);
    ASSERT_DOUBLE_EQ(d2f[0][0], 0.02146607964532761);
    ASSERT_DOUBLE_EQ(d2f[0][1], 0.05433382588472332);
    ASSERT_DOUBLE_EQ(d2f[1][0], 0.0543338258847233);
    ASSERT_DOUBLE_EQ(d2f[1][1], 0.2412036300850062);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.6663944579421156);
    ASSERT_DOUBLE_EQ(df[0], -1.315913545982157);
    ASSERT_DOUBLE_EQ(df[1], -0.8745194627136645);
    ASSERT_DOUBLE_EQ(d2f[0][0], 0.1394565419621314);
    ASSERT_DOUBLE_EQ(d2f[0][1], -0.04419259725744203);
    ASSERT_DOUBLE_EQ(d2f[1][0], -0.04419259725744201);
    ASSERT_DOUBLE_EQ(d2f[1][1], 0.3964897378720262);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 1.012456254930158);
    ASSERT_DOUBLE_EQ(df[0], -0.1277064300798806);
    ASSERT_DOUBLE_EQ(df[1], 0.140073786123401);
    ASSERT_DOUBLE_EQ(d2f[0][0], 5.327886039147272);
    ASSERT_DOUBLE_EQ(d2f[0][1], 2.558835075182847);
    ASSERT_DOUBLE_EQ(d2f[1][0], 2.558835075182847);
    ASSERT_DOUBLE_EQ(d2f[1][1], 1.630350556702507);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.8102532247452363);
    ASSERT_DOUBLE_EQ(df[0], -0.450287151146212);
    ASSERT_DOUBLE_EQ(df[1], -0.3755463418933428);
    ASSERT_DOUBLE_EQ(d2f[0][0], 0.113127418959527);
    ASSERT_DOUBLE_EQ(d2f[0][1], 0.493683542352749);
    ASSERT_DOUBLE_EQ(d2f[1][0], 0.4936835423527491);
    ASSERT_DOUBLE_EQ(d2f[1][1], 2.177922861450874);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.6227120026289962);
    ASSERT_DOUBLE_EQ(df[0], 0.04457909279171696);
    ASSERT_DOUBLE_EQ(df[1], 0.2139694297952391);
    ASSERT_DOUBLE_EQ(d2f[0][0], 2.644746157894539);
    ASSERT_DOUBLE_EQ(d2f[0][1], -2.763759804797053);
    ASSERT_DOUBLE_EQ(d2f[1][0], -2.763759804797053);
    ASSERT_DOUBLE_EQ(d2f[1][1], 2.951818740669762);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.4338486230780023);
    ASSERT_DOUBLE_EQ(df[0], -0.4465438244925446);
    ASSERT_DOUBLE_EQ(df[1], 0.1218356011000501);
    ASSERT_DOUBLE_EQ(d2f[0][0], 0.0572055551104876);
    ASSERT_DOUBLE_EQ(d2f[0][1], -0.0365541536716814);
    ASSERT_DOUBLE_EQ(d2f[1][0], -0.03655415367168141);
    ASSERT_DOUBLE_EQ(d2f[1][1], 0.03065044324699815);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.6481998345186274);
    ASSERT_DOUBLE_EQ(df[0], 0.05761143312148909);
    ASSERT_DOUBLE_EQ(df[1], 0.451516212604574);
    ASSERT_DOUBLE_EQ(d2f[0][0], 1.011444013947157);
    ASSERT_DOUBLE_EQ(d2f[0][1], -0.09267001267113532);
    ASSERT_DOUBLE_EQ(d2f[1][0], -0.09267001267113535);
    ASSERT_DOUBLE_EQ(d2f[1][1], 0.09281724916229861);
  }
}
...
TEST (cost_funcs, F1_works) {
  ...
  double lam[2] = {1./3, 1./3};
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.9277417461397732);
    ASSERT_DOUBLE_EQ(df[0], -0.1133734994151532);
    ASSERT_DOUBLE_EQ(df[1], -0.140282612382954);
    ASSERT_DOUBLE_EQ(d2f[0][0], 0.25858675084532861);
    ASSERT_DOUBLE_EQ(d2f[0][1], -0.2734996587352037);
    ASSERT_DOUBLE_EQ(d2f[1][0], -0.2734996587352037);
    ASSERT_DOUBLE_EQ(d2f[1][1], 0.3365816389629368);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.9552435580352215);
    ASSERT_DOUBLE_EQ(df[0], 0.1422049831297019);
    ASSERT_DOUBLE_EQ(df[1], -0.2732978213137259);
    ASSERT_DOUBLE_EQ(d2f[0][0], 0.3654487449203132);
    ASSERT_DOUBLE_EQ(d2f[0][1], 0.1019099328885245);
    ASSERT_DOUBLE_EQ(d2f[1][0], 0.1019099328885244);
    ASSERT_DOUBLE_EQ(d2f[1][1], -0.03492141241044397);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.9354846054549475);
    ASSERT_DOUBLE_EQ(df[0], -0.3697887584066532);
    ASSERT_DOUBLE_EQ(df[1], -0.9199344696831468);
    ASSERT_DOUBLE_EQ(d2f[0][0], 1.277447423581187);
    ASSERT_DOUBLE_EQ(d2f[0][1], 0.7950709805264409);
    ASSERT_DOUBLE_EQ(d2f[1][0], 0.795070980526441);
    ASSERT_DOUBLE_EQ(d2f[1][1], 0.7491310069183262);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.5625665483580271);
    ASSERT_DOUBLE_EQ(df[0], -0.4544144376448905);
    ASSERT_DOUBLE_EQ(df[1], 0.2456250444201228);
    ASSERT_DOUBLE_EQ(d2f[0][0], 1.937369008430461);
    ASSERT_DOUBLE_EQ(d2f[0][1], 2.219065295204201);
    ASSERT_DOUBLE_EQ(d2f[1][0], 2.2190652952042);
    ASSERT_DOUBLE_EQ(d2f[1][1], 1.65725997787241);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.6216362845903155);
    ASSERT_DOUBLE_EQ(df[0], 0.1809666396544651);
    ASSERT_DOUBLE_EQ(df[1], 0.6312877785721317);
    ASSERT_DOUBLE_EQ(d2f[0][0], 0.1203376694711638);
    ASSERT_DOUBLE_EQ(d2f[0][1], 0.1268138352144878);
    ASSERT_DOUBLE_EQ(d2f[1][0], 0.1268138352144878);
    ASSERT_DOUBLE_EQ(d2f[1][1], 0.2108079144710181);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    ASSERT_DOUBLE_EQ(f, 0.3251021429753333);
    ASSERT_DOUBLE_EQ(df[0], 0.0708733369651883);
    ASSERT_DOUBLE_EQ(df[1], 0.1308033314110975);
    ASSERT_DOUBLE_EQ(d2f[0][0], 0.7016186994936204);
    ASSERT_DOUBLE_EQ(d2f[0][1], 0.5563210804125802);
    ASSERT_DOUBLE_EQ(d2f[1][0], 0.5563210804125802);
    ASSERT_DOUBLE_EQ(d2f[1][1], 0.2980850527574);
  }
}
