...
void F0_works() {
  ...
  double lam[2] = {1./3, 1./3};
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.3629059042422889);
    IS_APPROX_EQUAL(df[0], 0.09385069562055104);
    IS_APPROX_EQUAL(df[1], -0.005830975252270845);
    IS_APPROX_EQUAL(d2f[0][0], 0.01398478137316401);
    IS_APPROX_EQUAL(d2f[0][1], -0.03387057681332327);
    IS_APPROX_EQUAL(d2f[1][0], -0.03387057681332326);
    IS_APPROX_EQUAL(d2f[1][1], 0.2802160611291685);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.8529368893174771);
    IS_APPROX_EQUAL(df[0], -0.1025834491128786);
    IS_APPROX_EQUAL(df[1], -0.3596024800247133);
    IS_APPROX_EQUAL(d2f[0][0], 1.272103018002429);
    IS_APPROX_EQUAL(d2f[0][1], 0.135763147743216);
    IS_APPROX_EQUAL(d2f[1][0], 0.135763147743216);
    IS_APPROX_EQUAL(d2f[1][1], 0.2751072086015301);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.9386573623510739);
    IS_APPROX_EQUAL(df[0], 0.2848236230267062);
    IS_APPROX_EQUAL(df[1], -0.1374461352207875);
    IS_APPROX_EQUAL(d2f[0][0], 0.02146607964532761);
    IS_APPROX_EQUAL(d2f[0][1], 0.05433382588472332);
    IS_APPROX_EQUAL(d2f[1][0], 0.0543338258847233);
    IS_APPROX_EQUAL(d2f[1][1], 0.2412036300850062);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.6663944579421156);
    IS_APPROX_EQUAL(df[0], -1.315913545982157);
    IS_APPROX_EQUAL(df[1], -0.8745194627136645);
    IS_APPROX_EQUAL(d2f[0][0], 0.1394565419621314);
    IS_APPROX_EQUAL(d2f[0][1], -0.04419259725744203);
    IS_APPROX_EQUAL(d2f[1][0], -0.04419259725744201);
    IS_APPROX_EQUAL(d2f[1][1], 0.3964897378720262);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 1.012456254930158);
    IS_APPROX_EQUAL(df[0], -0.1277064300798806);
    IS_APPROX_EQUAL(df[1], 0.140073786123401);
    IS_APPROX_EQUAL(d2f[0][0], 5.327886039147272);
    IS_APPROX_EQUAL(d2f[0][1], 2.558835075182847);
    IS_APPROX_EQUAL(d2f[1][0], 2.558835075182847);
    IS_APPROX_EQUAL(d2f[1][1], 1.630350556702507);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.8102532247452363);
    IS_APPROX_EQUAL(df[0], -0.450287151146212);
    IS_APPROX_EQUAL(df[1], -0.3755463418933428);
    IS_APPROX_EQUAL(d2f[0][0], 0.113127418959527);
    IS_APPROX_EQUAL(d2f[0][1], 0.493683542352749);
    IS_APPROX_EQUAL(d2f[1][0], 0.4936835423527491);
    IS_APPROX_EQUAL(d2f[1][1], 2.177922861450874);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.6227120026289962);
    IS_APPROX_EQUAL(df[0], 0.04457909279171696);
    IS_APPROX_EQUAL(df[1], 0.2139694297952391);
    IS_APPROX_EQUAL(d2f[0][0], 2.644746157894539);
    IS_APPROX_EQUAL(d2f[0][1], -2.763759804797053);
    IS_APPROX_EQUAL(d2f[1][0], -2.763759804797053);
    IS_APPROX_EQUAL(d2f[1][1], 2.951818740669762);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.4338486230780023);
    IS_APPROX_EQUAL(df[0], -0.4465438244925446);
    IS_APPROX_EQUAL(df[1], 0.1218356011000501);
    IS_APPROX_EQUAL(d2f[0][0], 0.0572055551104876);
    IS_APPROX_EQUAL(d2f[0][1], -0.0365541536716814);
    IS_APPROX_EQUAL(d2f[1][0], -0.03655415367168141);
    IS_APPROX_EQUAL(d2f[1][1], 0.03065044324699815);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.6481998345186274);
    IS_APPROX_EQUAL(df[0], 0.05761143312148909);
    IS_APPROX_EQUAL(df[1], 0.451516212604574);
    IS_APPROX_EQUAL(d2f[0][0], 1.011444013947157);
    IS_APPROX_EQUAL(d2f[0][1], -0.09267001267113532);
    IS_APPROX_EQUAL(d2f[1][0], -0.09267001267113535);
    IS_APPROX_EQUAL(d2f[1][1], 0.09281724916229861);
  }
}
...
void F1_works() {
  ...
  double lam[2] = {1./3, 1./3};
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.9277417461397732);
    IS_APPROX_EQUAL(df[0], -0.1133734994151532);
    IS_APPROX_EQUAL(df[1], -0.140282612382954);
    IS_APPROX_EQUAL(d2f[0][0], 0.25858675084532861);
    IS_APPROX_EQUAL(d2f[0][1], -0.2734996587352037);
    IS_APPROX_EQUAL(d2f[1][0], -0.2734996587352037);
    IS_APPROX_EQUAL(d2f[1][1], 0.3365816389629368);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.9552435580352215);
    IS_APPROX_EQUAL(df[0], 0.1422049831297019);
    IS_APPROX_EQUAL(df[1], -0.2732978213137259);
    IS_APPROX_EQUAL(d2f[0][0], 0.3654487449203132);
    IS_APPROX_EQUAL(d2f[0][1], 0.1019099328885245);
    IS_APPROX_EQUAL(d2f[1][0], 0.1019099328885244);
    IS_APPROX_EQUAL(d2f[1][1], -0.03492141241044397);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.9354846054549475);
    IS_APPROX_EQUAL(df[0], -0.3697887584066532);
    IS_APPROX_EQUAL(df[1], -0.9199344696831468);
    IS_APPROX_EQUAL(d2f[0][0], 1.277447423581187);
    IS_APPROX_EQUAL(d2f[0][1], 0.7950709805264409);
    IS_APPROX_EQUAL(d2f[1][0], 0.795070980526441);
    IS_APPROX_EQUAL(d2f[1][1], 0.7491310069183262);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.5625665483580271);
    IS_APPROX_EQUAL(df[0], -0.4544144376448905);
    IS_APPROX_EQUAL(df[1], 0.2456250444201228);
    IS_APPROX_EQUAL(d2f[0][0], 1.937369008430461);
    IS_APPROX_EQUAL(d2f[0][1], 2.219065295204201);
    IS_APPROX_EQUAL(d2f[1][0], 2.2190652952042);
    IS_APPROX_EQUAL(d2f[1][1], 1.65725997787241);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.6216362845903155);
    IS_APPROX_EQUAL(df[0], 0.1809666396544651);
    IS_APPROX_EQUAL(df[1], 0.6312877785721317);
    IS_APPROX_EQUAL(d2f[0][0], 0.1203376694711638);
    IS_APPROX_EQUAL(d2f[0][1], 0.1268138352144878);
    IS_APPROX_EQUAL(d2f[1][0], 0.1268138352144878);
    IS_APPROX_EQUAL(d2f[1][1], 0.2108079144710181);
  }
  {
    ...
    func.grad(df);
    func.hess(d2f);
    IS_APPROX_EQUAL(f, 0.3251021429753333);
    IS_APPROX_EQUAL(df[0], 0.0708733369651883);
    IS_APPROX_EQUAL(df[1], 0.1308033314110975);
    IS_APPROX_EQUAL(d2f[0][0], 0.7016186994936204);
    IS_APPROX_EQUAL(d2f[0][1], 0.5563210804125802);
    IS_APPROX_EQUAL(d2f[1][0], 0.5563210804125802);
    IS_APPROX_EQUAL(d2f[1][1], 0.2980850527574);
  }
}
