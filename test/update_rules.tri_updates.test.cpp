...
update_return_t tri(update_rules::rhr_tri_updates const & tri_updates,
           double u0, double u1, double s, double h) {
  return tri_updates.tri(u0, u1, s, 1, 1, h, ffvec<p0> {}, ffvec<p1> {});
}

update_return_t tri11(update_rules::rhr_tri_updates const & tri_updates,
             double u0, double u1, double s, double h) {
  return tri_updates.tri(u0, u1, s, 1, 1, h, ffvec<P01> {}, ffvec<P10> {});
}

update_return_t tri12(update_rules::rhr_tri_updates const & tri_updates,
             double u0, double u1, double s, double h) {
  return tri_updates.tri(u0, u1, s, 1, 1, h, ffvec<P01> {}, ffvec<P11> {});
}

update_return_t tri13(update_rules::rhr_tri_updates const & tri_updates,
             double u0, double u1, double s, double h) {
  return tri_updates.tri(u0, u1, s, 1, 1, h, ffvec<P001> {}, ffvec<P111> {});
}

update_return_t tri22(update_rules::rhr_tri_updates const & tri_updates,
             double u0, double u1, double s, double h) {
  return tri_updates.tri(u0, u1, s, 1, 1, h, ffvec<P011> {}, ffvec<P101> {});
}

update_return_t tri23(update_rules::rhr_tri_updates const & tri_updates,
             double u0, double u1, double s, double h) {
