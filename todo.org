...
* New Newton's method (constrained) for tetrahedra
  ...
  - [ ] get olim to conditionally use moore marcher or neumann marcher
    ...
    - [ ] will need to order nodes by degree to do this
    - [ ] also make sure that the size of the arrow allocated is
      correct depending on a template parameter
