...
* Collected from <2017-10-23 Mon>
  ...
  - [ ] try sup'd up line search for tri newton
  - [ ] get "agrees_with" test to work for olim26mp1
  - [ ] do larger agrees with tests
  - [ ] add olim 3d mp1s to errors3d.m and check for stalling in
    newton iterationsx
  - [ ] templatized speed func test
    - [ ] 2D
      - [ ] is_symmetric
      - [ ] error_is_no_worse_than (mp0 vs mp1)
    - [ ] 3D
      - [ ] is_symmetric
      - [ ] error_is_no_worse_than (mp0 vs mp1)
