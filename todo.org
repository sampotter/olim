...
* General refactoring
  ...
  5. [ ] get_value -> get_U
  6. [ ] T -> U everwhere
  7. [ ] Add T = template parameter for double/float
  8. [ ] Distinguish between indices
  ...
  9. [ ] Remove second argument from `sqp_bary': i.e., use only one
  ...
  10. [ ] Don't actually need to store qr_wkspc in cost_functor...
  11. [ ] Reduce line count in tests using generic lambdas...
