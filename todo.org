...
* Bugs
  - [ ] get ctest to fail when it turns into segmentation faults
* New Newton's method (constrained) for tetrahedra
  ...
  - [-] get all tests working
    /check if it's just the speed functions being implemented/
    /incorrectly---they haven't been tested before!/
    - [ ] olim18_mp0.test.cpp
    - [ ] olim18_mp1.test.cpp
    - [ ] olim18_rhr.test.cpp
    - [ ] olim26_mp0.test.cpp
...
** big olim3d plot
   - [ ] sort entries by how many tetra updates they have to do (i.e.,
     fixed number for each bit, sum them up)
