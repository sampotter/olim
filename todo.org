...
** SQP rewrite
*** Loglog time-vs-accuracy plots
*** Hierarchical update
*** Trial node optimization
    - We've more or less implemented this, but it has a bug
    - It seems like the bug might be due to inconsistency of cost
      functions
*** Big olim3d plot
